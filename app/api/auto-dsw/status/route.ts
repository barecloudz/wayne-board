...
export async function GET() {
  ...
  const [rows, lastSynced, autoEnabled, lastSyncResultRaw] = await Promise.all([
  ...
  return NextResponse.json({ rows, lastSynced, autoEnabled: autoEnabled === "true", lastSyncResult, orgId });
}
