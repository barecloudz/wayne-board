  ...
  return (
    <>
      <button
        ...
        className="px-4 py-2 rounded-lg text-[13px] font-semibold border border-red-200
          text-red-500 bg-white hover:bg-red-50 hover:border-red-300
          ...
          <div className="bg-white rounded-2xl shadow-[0_24px_64px_rgba(0,0,0,0.25)] w-full max-w-sm">
            <div className="px-6 pt-6 pb-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-[16px] font-extrabold text-slate-900">Delete Inspection?</h2>
              </div>
              <p className="text-[13px] text-slate-500">
                This will permanently remove the inspection and all 20 component results. This cannot be undone.
              </p>
            </div>
